...
<div class="cm-tabs-content" id="tabs_content">
    <div id="content_tab_general">
        ...
        {foreach from=$order_info.products item="product" key="key"}
            ...
            {assign var="group_id" value=$product.extra.group_key}
            <tr>
                <td>
