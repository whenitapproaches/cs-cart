<div class="control-group setting-wide" id="paypal_ver_image_uploader">
    <label class="control-label" for="elm_paypal_verification_image">{__("paypal_ver_image")}{include file="common/tooltip.tpl" tooltip={__("paypal_adaptive.tooltips.paypal_ver_image")}}:</label>
    <div class="controls">
