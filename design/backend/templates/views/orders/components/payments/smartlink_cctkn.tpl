...
{if $payment_method.processor_params.mode == "test"}
    <script type="text/javascript" src="https://www.test.e-scott.jp/euser/stn/CdGetJavaScript.do?k_TokenNinsyoCode={$payment_method.processor_params.token_ninsyo_code}" callBackFunc="setToken" class="spsvToken" ></script>
{elseif $payment_method.processor_params.mode == "live"}
    <script type="text/javascript" src="https://www.e-scott.jp/euser/stn/CdGetJavaScript.do?k_TokenNinsyoCode={$payment_method.processor_params.token_ninsyo_code}" callBackFunc="setToken" class="spsvToken" ></script>
{/if}
