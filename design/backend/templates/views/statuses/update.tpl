...
<fieldset>
    ...
    <div class="control-group">
        <label for="status_sort_id" class="control-label">{__("sort_by")}</label>
        <div class="controls">
            <input type="text" size="3" name="status_sort_id" id="status_sort_id" value="{$status_sort_id}" class="input-text-short" />
        </div>
    </div>
