    ...
    <div class="bulk-edit-inner__body">
        ...
        <div class="bulk-edit-inner__input-group">
            <input type="number" 
                   ...
                   placeholder="{if $smarty.const.CART_LANGUAGE == 'ja'}{__("jp_inventory_count")}{else}{__("in_stock")}{/if}"
{* Modified by takahashi from cs-cart.jp 2018  EOF *}
        ...
        <div class="bulk-edit-inner__example">
            ...
            <p class="bulk-edit-inner__example-line">
                <span class="bulk-edit-inner__example-line--left">{* Modified by takahashi from cs-cart.jp 2018  BOF *}{if $smarty.const.CART_LANGUAGE == 'ja'}{__("jp_inventory_count")}{else}{__("in_stock")}{/if}{* Modified by takahashi from cs-cart.jp 2018  EOF *}:</span>
                <span class="bulk-edit-inner__example-line--right"
