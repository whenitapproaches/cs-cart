...
CREATE TABLE ?:jp_krnkwc_all_shipments (order_id mediumint(8) unsigned NOT NULL, tracking_number	varchar(255) NOT NULL, carrier varchar(255) NOT NULL, delivery_service_code varchar(2) NOT NULL, 	timestamp	int(11) NOT NULL, PRIMARY KEY (`order_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8;
