...
function fn_lcjp_configure_japanese_version()
{
    ...
    $profile_sort_order = array(
        ...
        'b_firstname' => array('position' => 90, 'profile_required' => 'Y', 'checkout_required' => 'Y', 'section' => 'B', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        'b_lastname' => array('position' => 100, 'profile_required' => 'Y', 'checkout_required' => 'Y', 'section' => 'B', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        'b_firstname_kana' => array('field_name' => 'b_firstname_kana', 'position' => 110, 'section' => 'B', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        'b_lastname_kana' => array('field_name' => 'b_lastname_kana', 'position' => 120, 'section' => 'B', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        'b_phone' => array('position' => 140, 'profile_required' => 'Y', 'checkout_required' => 'Y', 'section' => 'B', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        'b_country' => array('position' => 150, 'section' => 'B', 'profile_show' => 'Y', 'checkout_show' => 'Y', 'checkout_required' => 'Y'),
        'b_zipcode' => array('position' => 160, 'section' => 'B', 'profile_show' => 'Y', 'checkout_show' => 'Y', 'checkout_required' => 'Y'),
        ...
        'b_address' => array('position' => 190, 'section' => 'B', 'profile_show' => 'Y', 'checkout_show' => 'Y', 'checkout_required' => 'Y'),
        'b_address_2' => array('position' => 200, 'section' => 'B', 'profile_show' => 'Y', 'checkout_show' => 'Y'),

        's_firstname' => array('position' => 210, 'profile_required' => 'Y', 'checkout_required' => 'Y', 'section' => 'S', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        's_lastname' => array('position' => 220, 'profile_required' => 'Y', 'checkout_required' => 'Y', 'section' => 'S', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        's_firstname_kana' => array('field_name' => 's_firstname_kana', 'position' => 230, 'section' => 'S', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        's_lastname_kana' => array('field_name' => 's_lastname_kana', 'position' => 240, 'section' => 'S', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        's_phone' => array('position' => 260, 'profile_required' => 'Y', 'checkout_required' => 'Y', 'section' => 'S', 'profile_show' => 'Y', 'checkout_show' => 'Y'),
        's_country' => array('position' => 270, 'section' => 'S', 'profile_show' => 'Y'),
        's_zipcode' => array('position' => 280, 'section' => 'S', 'profile_show' => 'Y'),
        's_state' => array('position' => 290, 'section' => 'S', 'profile_show' => 'Y'),
        's_city' => array('position' => 300, 'section' => 'S', 'profile_show' => 'Y', 'profile_required' => 'N'),
        's_address' => array('position' => 310, 'section' => 'S', 'profile_show' => 'Y'),
        's_address_2' => array('position' => 320, 'section' => 'S', 'profile_show' => 'Y'),
    ...
    /////////////////////////////////////////////////////////////////////////
        ...
        $jp_shipping_methods = array(
            ...
            array('shipping' => 'フクツー宅配便', 'min_weight' => '0.00', 'rate_calculation' => 'R', 'service_id' => 9006, 'service_params' => array('jp_shipping' => 'Y')),
