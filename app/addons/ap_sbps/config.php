...
const SBPS_PAY_METHODS = [
    ...
    'recruit', 'alipay', 'paypal', 'netmile', 'softbank2', 'linepay', 'tpoint', 'applepay'
];
...
const SBPS_PAY_METHOD_SPECIFIED_SALES = [
    'credit', 'credit3d', 'docomo', 'auone', 'softbank2', 'recruitc', 'yahoowallet', 'linepay', 'applepay'
];
...
const SBPS_PAY_METHOD_ORDER_STATUS_P = [
    ...
    'mysoftbank', 'softbank2', 'saisonpoint', 'linepay', 'tpoint', 'applepay'
];
