...
if (defined('PAYMENT_NOTIFICATION')) {
	...
	// 完了テンプレートURL
	$remise_data['RETURL'] = fn_url("payment_notification.process&payment=remise_cc&order_id=$order_id", AREA, 'current');

	// オプション
	$remise_data['OPT'] = '';

	// NG完了通知URL
	$remise_data['NG_RETURL'] = fn_url("payment_notification.cancelled&payment=remise_cc&order_id=$order_id", AREA, 'current');
