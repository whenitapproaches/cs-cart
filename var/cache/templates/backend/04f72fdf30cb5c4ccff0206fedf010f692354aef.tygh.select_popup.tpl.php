<?php /* Smarty version Smarty-3.1.21, created on 2021-06-04 11:08:45
         compiled from "C:\xampp\htdocs\cs-jp\design\backend\templates\common\select_popup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:189660898660b98b2d59e888-04468543%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '04f72fdf30cb5c4ccff0206fedf010f692354aef' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cs-jp\\design\\backend\\templates\\common\\select_popup.tpl',
      1 => 1543470808,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '189660898660b98b2d59e888-04468543',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60b98b2d5eb1f7_65221877',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60b98b2d5eb1f7_65221877')) {function content_60b98b2d5eb1f7_65221877($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cs-jp/app/functions/smarty_plugins\\block.hook.php';
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_notify" value="Y" <?php if ($_smarty_tpl->tpl_vars['jp_notify_customer_checked']->value=='Y') {?>checked="checked" <?php }?>onclick="Tygh.$('input[name=__notify_user]').prop('checked', this.checked);" />
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_notify_department" value="Y" <?php if ($_smarty_tpl->tpl_vars['jp_notify_admin_checked']->value=='Y') {?>checked="checked" <?php }?>onclick="Tygh.$('input[name=__notify_department]').prop('checked', this.checked);" />
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_notify_vendor" value="Y" <?php if ($_smarty_tpl->tpl_vars['jp_notify_vendor_checked']->value=='Y') {?>checked="checked" <?php }?>onclick="Tygh.$('input[name=__notify_vendor]').prop('checked', this.checked);" />
