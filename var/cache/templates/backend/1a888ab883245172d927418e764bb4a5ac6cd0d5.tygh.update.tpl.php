<?php /* Smarty version Smarty-3.1.21, created on 2021-06-08 22:29:53
         compiled from "C:\xampp\htdocs\cs-jp\design\backend\templates\views\products\update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:165616580560bf70d172ed97-32375390%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1a888ab883245172d927418e764bb4a5ac6cd0d5' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cs-jp\\design\\backend\\templates\\views\\products\\update.tpl',
      1 => 1568343242,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '165616580560bf70d172ed97-32375390',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60bf70d18347f6_17798626',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bf70d18347f6_17798626')) {function content_60bf70d18347f6_17798626($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cs-jp/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('information','name','text_ult_product_store_field_tooltip','categories','tt_views_products_update_categories','price','full_description','edit_content_on_site','images','options_settings','options_type','simultaneous','sequential','exceptions_type','forbidden','allowed','pricing_inventory','sku','list_price','tt_views_products_update_list_price','jp_inventory_count','edit','zero_price_action','zpa_refuse','zpa_permit','zpa_ask_price','inventory','tt_views_products_update_inventory','track_with_options','track_without_options','dont_track','min_order_qty','max_order_qty','quantity_step','list_quantity_count','taxes','availability','usergroups','creation_date','available_since','out_of_stock_actions','tt_views_products_update_out_of_stock_actions','none','buy_in_advance','sign_up_for_notification','product_details_view','downloadable','edp_enable_shipping','time_unlimited_download','short_description','popularity','ttc_popularity','search_words','ttc_search_words','promo_text','extra','seo_meta_data','page_title','ttc_page_title','meta_description','meta_keywords','preview','clone','delete','editing_product','new_product'));
?>
