...
" <?php if ($_smarty_tpl->tpl_vars['payment']->value['template']==$_smarty_tpl->tpl_vars['full_path']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['template']->value, ENT_QUOTES, 'UTF-8');?>
        ...
        <div class="control-group" data-ca-form-group="category">
            ...
            <?php if ($_smarty_tpl->tpl_vars['addons']->value['localization_jp']['jp_categorize_payment_method']=='N') {?>
                <input type="hidden" id="elm_payment_category_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
" name="payment_data[payment_category]" value="tab3" />
            <?php } else { ?>
