<?php /* Smarty version Smarty-3.1.21, created on 2021-06-08 06:02:50
         compiled from "C:\xampp\htdocs\cs-jp\design\themes\responsive\templates\common\product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12784965760be897a66fad1-22688453%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f075a11455340bc0c4d3cd090a174109c0a2eb03' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cs-jp\\design\\themes\\responsive\\templates\\common\\product_data.tpl',
      1 => 1622772464,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12784965760be897a66fad1-22688453',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60be897a962ad2_61345859',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60be897a962ad2_61345859')) {function content_60be897a962ad2_61345859($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cs-jp/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('text_combination_out_of_stock','text_out_of_stock','sku','select_options','notify_when_back_in_stock','email','enter_email','enter_email','go','including_tax','old_price','list_price','including_tax','enter_your_price','contact_us_for_price','sign_in_to_view_price','jp_exc_tax','you_save','you_save','save_discount','free_shipping','save_discount','save_discount','jp_availability','items','on_backorder','in_stock','jp_availability','jp_order_allowed','in_stock','on_backorder','jp_availability','quantity','text_cart_min_qty','text_edp_product','text_combination_out_of_stock','text_out_of_stock','sku','select_options','notify_when_back_in_stock','email','enter_email','enter_email','go','including_tax','old_price','list_price','including_tax','enter_your_price','contact_us_for_price','sign_in_to_view_price','jp_exc_tax','you_save','you_save','save_discount','free_shipping','save_discount','save_discount','jp_availability','items','on_backorder','in_stock','jp_availability','jp_order_allowed','in_stock','on_backorder','jp_availability','quantity','text_cart_min_qty','text_edp_product'));
?>
...
}?>%<?php if (@constant('CART_LANGUAGE')=='ja') {?>OFF<?php }?></span></span>
