...
<form name="{$form_name}" action="{""|fn_url}" method="get" class="search-by-geodata">
    ...
    <div class="ty-product-filters__wrapper">
        ...
        <div class="ty-product-filters__tools clearfix">
            <a href="{"companies.catalog?reset=1"|fn_url}" rel="nofollow" class="ty-product-filters__reset-button"><i class="ty-product-filters__reset-icon ty-icon-cw"></i> {__("reset")}</a>
        </div>
    </div>
