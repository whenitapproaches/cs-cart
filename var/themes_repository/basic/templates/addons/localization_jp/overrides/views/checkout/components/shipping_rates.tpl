                        ...
                        {if $delivery_timing|@count}
                            {if $delivery_timing.delivery_time_array|@count}
                                <div class="jp_delivery_option">
                                    <label for= "delivery_time_selected_{$group_key}_{$shipping.shipping_id}">{__("jp_shipping_delivery_time")}ï¼¡¦/label>
                            ...
                            {if $delivery_timing.delivery_date_array|@count}
                                <div class="jp_delivery_option">
                                    <label for= "delivery_date_selected_{$group_key}_{$shipping.shipping_id}">{__("jp_delivery_date")}ï¼¡¦/label>
